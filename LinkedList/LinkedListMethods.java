...
public class LinkedList1 {
    ...
    public int helper(Node head,int key){
        //base case
        if(head == null){
            return -1; //reached end of the list & key not found
        }
        if(head.data == key){
            return 0;
        }
        ...
        return idx+1; //happens while coming back
    }
    ...
    public void reverse(){
        ...
        head=prev; // bcz curr has become null
    }
...
// slow fast concept
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("key found at index: " + ll.recSearch(4));
